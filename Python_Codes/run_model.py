...
def run_model(nproc,pathres,cygfolder):
    ...
    os.system('C:/cygwin64/bin/bash --login -c "cd %s; mpirun --use-hwthread-cpus -np %s /cygdrive/f/Adcirc_SWAN/PARTneR2/ADCIRC55/ADCIRC55/padcswan_SH"' %(cygfolder,str(nproc)))
    try: 
...
#nproc = 28
#pathres = 'F:/Adcirc_SWAN/PARTneR2/Test_Runs/LOLA_Test/'
#cygfolder = '/cygdrive/f/Adcirc_SWAN/PARTneR2/Test_Runs/LOLA_Test'
