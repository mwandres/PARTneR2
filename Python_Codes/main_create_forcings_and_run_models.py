...
pathres='F:/Adcirc_SWAN/PARTneR2/Test_Runs/Wilma_Test_SATO2/'
cygfolder = '/cygdrive/f/Adcirc_SWAN/PARTneR2/Test_Runs/Wilma_Test_SATO2'

wind_in = 'F:/Adcirc_SWAN/PARTneR2/BestTrack/TC_Wilma_2011.csv'
nproc = 28

#####
input_folder = 'F:/Adcirc_SWAN/PARTneR2/input_files_SATO2/'
...
tore_output_at_point_locations(pathres,input_folder,output_locations_csv2,outfilename2)
