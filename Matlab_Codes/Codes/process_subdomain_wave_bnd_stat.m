function process_subdomain_wave_bnd(folder,HS,PER,DIR,DD)
...
for i=1:length(sub(:,1));
    ...
    if length(bndnodes)>0
       ...
       textobnd=['BOU SHAP JON 3.3 PEAK DSPR DEGR \n '];
       
           texto =['BOUN SIDE 1 CON PAR ',num2str(HS),' ',num2str(PER),' ',num2str(DIR),' ',num2str(DD)];
